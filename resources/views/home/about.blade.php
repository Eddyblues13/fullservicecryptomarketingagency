                ...
                <div class="uk-width-2-3@m">
                    <div class="uk-grid uk-grid-small" data-uk-grid>
                        ...
                        <div class="uk-width-expand">
                            <h3 style="color:#fff;">Why trade with Fullservicecryptomarketingagency?</h3>
        ...
        <div class="uk-container">
            <div class="uk-grid">
                <div class="uk-width-1-1 uk-text-center uk-margin-medium-bottom">
                    <h1 style="color:#fff;">Fullservicecryptomarketingagency Legal Docs</h1>
                </div>
                    ...
                    <div class="uk-card uk-card-large uk-card-default in-card-paper">
                        <div class="uk-card-body">
                            ...
                            <div class="uk-card uk-card-default uk-card-small uk-card-body uk-border-rounded uk-margin-medium-top">
                                <p class="uk-text-small">For general inquiries please contact <a class="uk-text-lowercase uk-link" href="mailto:">support@fullservicecryptomarketingagency.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
