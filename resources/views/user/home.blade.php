...
<head>
    ...
    <!-- Site Properties -->
    <title>Dashboard - Fullservicecryptomarketingagency.</title>
...
<body style="background-color:#000;">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 text-right">
                    Copyright 2022 10x Fullservicecryptomarketingagency.</a> All Rights Reserved.
                </div>
            </div>
        </div>
    </footer>
    ...
    <script type="text/javascript">
        (function() {
                var options = {
                    whatsapp: "+1(613) 663-2946", // WhatsApp number
